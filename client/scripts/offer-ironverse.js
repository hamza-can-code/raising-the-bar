...
//   coachImg.src = imgSrc('ironverse-coach.JPG');
...
// };
  ...
  if (userGoal === "lose weight") {
    ...
    heroLine1 = `
      <strong>${name}</strong>,
      Ironverse has built you a personalized plan to help you lose
    ...
    const diffDisplay = weightUnit === "lbs"
      ...
      : diffKg;
    heroLine1 = `
      ${name}, Ironverse has built you a personalized plan to help you gain
      <strong>${diffDisplay.toFixed(1)} ${weightUnit}</strong>
      of muscle.
    `;
  }
    ...
    const targetDisplay = weightUnit === "lbs"
      ...
      : goalKg;
    heroLine1 = `
      ${name}, Ironverse has built you a personalized plan to help you reach
  your goal weight of
  ...
  const whatsIncludedData = [
    {
      ...
      image: "../assets/your-ui-mockup-ironverse.png",
      desc: ""
    },
    {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultReviews = [
    ...
    },
    {
      ...
      rating: 4,
      time: 'Today',
      text: 'Been watching ironverses tiktok for a bit, I found his vids helpful so thought id gv his app a go. been using this for a couple of weeks and its genuinely amazing (avging 2kg muscle per week). Was going to rate 5 stars but the rest timer bugged once on me so im leaving a 4 til they patch it 💔 still worth it tho',
    },
    {
      name: 'alex',
      rating: 5,
