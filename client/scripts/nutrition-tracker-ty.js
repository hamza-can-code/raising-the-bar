...
function renderDailyMealDisplay() {
  ...
  if (currentDayIndex === 0) {  // Only Day 1 has a Meal Prep Mode button
    ...
    mealPrepBtn.style.backgroundColor = "#39FF14";
  ...
  if (totalMealsToday > 0 && mealsInteractedCount === totalMealsToday) {
    ...
    summaryBtn.style.backgroundColor = "#39FF14";
...
function showSummaryPopup() {
  ...
  summaryDetails.innerHTML = `
    <div style="text-align: center; background: #161514; padding: 12px; border-radius: 5px; border: 1px solid #39FF14FC0;">
...
function showMealPrepModePopup(weekIndex) {
  ...
  summaryTab.style.borderBottom = "2px solid #39FF14";
  ...
  shoppingTab.addEventListener("click", () => {
    if (activeTab !== "shopping") {
      ...
      shoppingTab.style.borderBottom = "2px solid #39FF14";
  ...
  weeklySummaryContent.style.backgroundColor = "#151412";
  weeklySummaryContent.style.padding = "0 16px";
  weeklySummaryContent.style.borderRadius = "12px";
  weeklySummaryContent.style.border = "1px solid #262422";
  ...
  shoppingListContent.style.backgroundColor = "#151412";
  shoppingListContent.style.padding = "0 16px";
  shoppingListContent.style.borderRadius = "12px";
  shoppingListContent.style.border = "1px solid #262422";
  ...
  copyListBtn.style.backgroundColor = "#39FF14";
...
function makeSwipeableNT(rail, dots) {
  ...
  rail.addEventListener('touchend',    e => {
    ...
    if (Math.abs(diff) < 40) return;              // ignore micro-drags
    index = (diff < 0)
      ? (index + 1) % total                       // swipe left  → next
      : (index - 1 + total) % total;             // swipe right → prev
    update();
  }, opts);

  /* ---------- mouse (desktop dev-tools / fallback) ---------- */
