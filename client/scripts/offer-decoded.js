  ...
  const whatsIncludedData = [
    {
      ...
      image: "../assets/your-ui-mockup-decoded.webp",
      desc: ""
    },
    {
      title: "Track Workouts, Earn XP (CT)",
      image: "../assets/clear-and-easy-decoded.webp",
      desc: ""
    },
    {
    ...
    // },
    {
      ...
      image: "../assets/progress-tracking-decoded.webp",
      desc: ""
    }
    //     {
    //   title: "Macro-Matched Meals (PT)",
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultReviews = [
    ...
    },
    {
      ...
      rating: 4,
      time: 'Today',
      text: 'Been watching decoded gains tiktok for a bit, I found his vids helpful so thought id gv his app a go. been using this for a couple of weeks and its genuinely amazing (avging 0.6kg muscle per week). Was going to rate 5 stars but the rest timer bugged once on me so im leaving a 4 til they patch it 💔 still worth it tho',
    },
    {
      name: 'alex',
      rating: 5,
