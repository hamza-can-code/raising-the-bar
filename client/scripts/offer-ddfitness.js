...
document.addEventListener("DOMContentLoaded", () => {
  ...
  coachImg.src = imgSrc('ddfitness-coach.webp');
  coachImg.alt = 'Coach DDFitness';
};
...
`;
  ...
  if (userGoal === "gain muscle") {
    ...
    selectedReviewText =
      "I used to wing it with random exercises and YouTube routines. Having a personalized plan built for me but using DDFitness's structure to follow has genuinely changed my life. I've built 6 kg of lean muscle all from home.";
    ...
    if (gender === "male") {
      ...
      selectedReviewText =
        "I wasn’t sure I could stick with it. But everything’s laid out, and I found it helpful following the same structure DDFitness uses. I’ve lost 10kg and finally feel like myself again.";
...
document.addEventListener("DOMContentLoaded", () => {
   ...
   ***************************************************/
    ...
    const whatsIncludedData = [
    {
      ...
      image: "../assets/your-ui-mockup-ddfitness.webp",
      desc: ""
    },
    {
    ...
    },
    {
      ...
      image: "../assets/my-mind-ddfitness.webp",
      desc: ""
    },
    {
      title: "The same structure creator follows",
      image: "../assets/ddfitness-structure.webp",
      desc: ""
    },
    {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultReviews = [
    ...
    },
    {
      ...
      rating: 4,
      time: 'Today',
      text: "Been watching ddfitness's tiktok for a bit, I found his vids helpful so thought id gv his app a go. been using this for a couple of weeks and its genuinely amazing (avging 0.6kg muscle per week). Was going to rate 5 stars but the rest timer bugged once on me so im leaving a 4 til they patch it 💔 still worth it tho",
    },
    {
      name: 'alex',
      rating: 5,
