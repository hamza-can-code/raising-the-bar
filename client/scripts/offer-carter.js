...
document.addEventListener("DOMContentLoaded", () => {
  ...
  coachImg.src = imgSrc('carter-coach.webp');
  coachImg.alt = 'Coach carter';
};
...
`;
  ...
  if (userGoal === "gain muscle") {
    ...
    selectedReviewText =
      "I used to wing it with random exercises and YouTube routines. Having a personalized plan built for me but using carter's structure to follow has genuinely changed my life. I've built 6 kg of lean muscle all from home.";
    ...
    if (gender === "male") {
      ...
      selectedReviewText =
        "I wasn’t sure I could stick with it. But everything’s laid out, and I found it helpful following the same structure carter uses. I’ve lost 10kg and finally feel like myself again.";
...
document.addEventListener("DOMContentLoaded", () => {
   ...
   ***************************************************/
    ...
    const whatsIncludedData = [
    {
      ...
      image: "../assets/your-ui-mockup-carter.webp",
      desc: ""
    },
    {
    ...
    },
    {
      ...
      image: "../assets/my-mind-carter.webp",
      desc: ""
    },
    {
      title: "The same structure creator follows",
      image: "../assets/carter-structure.webp",
      desc: ""
    },
    {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultReviews = [
    ...
    },
    {
      ...
      rating: 4,
      time: 'Today',
      text: "Been watching carter's TikTok for a bit, I found his vids helpful so thought id gv his app a go. been using this for a couple of weeks and its genuinely amazing (avging 0.6kg muscle per week). Was going to rate 5 stars but the rest timer bugged once on me so im leaving a 4 til they patch it 💔 still worth it tho",
    },
    {
      name: 'alex',
      rating: 5,
