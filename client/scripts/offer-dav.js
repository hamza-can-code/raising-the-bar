...
document.addEventListener("DOMContentLoaded", () => {
  ...
  coachImg.src = imgSrc('dav-coach.JPG');
  ...
  if (userGoal === "lose weight") {
    ...
    heroLine1 = `
      <strong>${name}</strong>,
      Dav has built you a personalized plan to help you lose
    ...
    const diffDisplay = weightUnit === "lbs"
      ...
      : diffKg;
    heroLine1 = `
      ${name}, Dav has built you a personalized plan to help you gain
      <strong>${diffDisplay.toFixed(1)} ${weightUnit}</strong>
      of muscle.
    `;
  }
    ...
    const targetDisplay = weightUnit === "lbs"
      ...
      : goalKg;
    heroLine1 = `
      ${name}, Dav has built you a personalized plan to help you reach
  your goal weight of
  ...
  const whatsIncludedData = [
    {
      ...
      image: "../assets/your-ui-mockup-dav.png",
      desc: ""
    },
    {
      ...
      image: "../assets/dav-structure.png",
      desc: ""
    },
    {
      title: "Adaptive Progression Engine (PT)",
