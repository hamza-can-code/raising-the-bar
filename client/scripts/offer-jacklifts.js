...
document.addEventListener("DOMContentLoaded", () => {
  ...
  coachImg.src = imgSrc('jacklifts-coach.webp');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultReviews = [
    ...
    },
    {
      ...
      rating: 4,
      time: 'Today',
      text: 'Been watching jackliftss tiktok for a bit, I found his vids helpful so thought id gv his app a go. been using this for a couple of weeks and its genuinely amazing (avging 0.6kg muscle per week). Was going to rate 5 stars but the rest timer bugged once on me so im leaving a 4 til they patch it 💔 still worth it tho',
    },
    {
      name: 'alex',
      rating: 5,
