...
function replaceWithFinalPage() {
  ...
  <h2 class="final-headline">
    <span class="final-num">5,000+</span><br>
    <span class="final-sub"><strong>kick-started their journey using Carl's structure</strong></span>
  </h2>
  ...
  <p class="final-reviews">1,300+ five-star reviews from happy users</p>
`;
...
window.location.href = "../pages/sign-up-carl.html";
    }
  }
  requestAnimationFrame(fillBar);
}
