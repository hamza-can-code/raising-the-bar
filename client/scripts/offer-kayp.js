...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (userGoal === "lose weight") {
    ...
    heroLine1 = `
      <strong>${name}</strong>,
      KayP has built you a personalized plan to help you lose
    ...
    const diffDisplay = weightUnit === "lbs"
      ...
      : diffKg;
    heroLine1 = `
      ${name}, KayP has built you a personalized plan to help you gain
      <strong>${diffDisplay.toFixed(1)} ${weightUnit}</strong>
      of muscle.
    `;
  }
    ...
    const targetDisplay = weightUnit === "lbs"
      ...
      : goalKg;
    heroLine1 = `
      ${name}, KayP has built you a personalized plan to help you reach
  your goal weight of
