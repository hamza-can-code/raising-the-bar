...
`;
  ...
  if (userGoal === "gain muscle") {
    ...
    selectedReviewText =
      "I used to wing it with random exercises and YouTube routines. Having a personalized plan built for me but using Kalix's structure to follow has genuinely changed my life. I've built 6 kg of lean muscle all from home.";
    ...
    if (gender === "male") {
      ...
      selectedReviewText =
        "I wasn’t sure I could stick with it. But everything’s laid out, and I found it helpful following the same structure Kalix uses. I’ve lost 10kg and finally feel like myself again.";
...
document.addEventListener("DOMContentLoaded", () => {
   ...
   ***************************************************/
    ...
    const whatsIncludedData = [
    {
      ...
      image: "../assets/your-ui-mockup-kalix.webp",
      desc: ""
    },
    {
    ...
    },
    {
      ...
      image: "../assets/my-mind-kalix.webp",
      desc: ""
    },
    {
      title: "The same structure creator follows",
      image: "../assets/kalix-structure.webp",
      desc: ""
    },
    {
